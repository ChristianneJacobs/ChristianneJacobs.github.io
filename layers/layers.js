...
ol.proj.get("EPSG:3416").setExtent([100166.570953, 330365.376843, 222579.711867, 415235.825273]);
var wms_layers = [];
...
var format_Metaclusters_10 = new ol.format.GeoJSON();
var features_Metaclusters_10 = format_Metaclusters_10.readFeatures(json_Metaclusters_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3416'});
var jsonSource_Metaclusters_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Metaclusters_10.addFeatures(features_Metaclusters_10);
var lyr_Metaclusters_10 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Metaclusters_10, 
                style: style_Metaclusters_10,
                interactive: true,
    title: 'Metaclusters<br />\
    <img src="styles/legend/Metaclusters_10_0.png" /> Gold nugget<br />\
    <img src="styles/legend/Metaclusters_10_1.png" /> Tier B<br />\
    <img src="styles/legend/Metaclusters_10_2.png" /> Tier C<br />'
        });
var format_ClusterPolygons_11 = new ol.format.GeoJSON();
var features_ClusterPolygons_11 = format_ClusterPolygons_11.readFeatures(json_ClusterPolygons_11, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3416'});
var jsonSource_ClusterPolygons_11 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ClusterPolygons_11.addFeatures(features_ClusterPolygons_11);
var lyr_ClusterPolygons_11 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_ClusterPolygons_11, 
                style: style_ClusterPolygons_11,
                interactive: true,
                title: '<img src="styles/legend/ClusterPolygons_11.png" /> Cluster Polygons'
            });
var format_VorarlbergBorder_12 = new ol.format.GeoJSON();
var features_VorarlbergBorder_12 = format_VorarlbergBorder_12.readFeatures(json_VorarlbergBorder_12, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3416'});
var jsonSource_VorarlbergBorder_12 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_VorarlbergBorder_12.addFeatures(features_VorarlbergBorder_12);
var lyr_VorarlbergBorder_12 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_VorarlbergBorder_12, 
                style: style_VorarlbergBorder_12,
                interactive: true,
                title: '<img src="styles/legend/VorarlbergBorder_12.png" /> Vorarlberg Border'
            });

lyr_GoogleMaps_0.setVisible(true);lyr_GoogleSatellite_1.setVisible(true);lyr_OpenStreetMap_2.setVisible(true);lyr_BuildingConnections_3.setVisible(true);lyr_OptimizedNetwork_4.setVisible(true);lyr_AddressPolygons_5.setVisible(true);lyr_AddressPoints_6.setVisible(true);lyr_FTTH_7.setVisible(true);lyr_DOCSIS_8.setVisible(true);lyr_xDSL_9.setVisible(true);lyr_Metaclusters_10.setVisible(true);lyr_ClusterPolygons_11.setVisible(true);lyr_VorarlbergBorder_12.setVisible(true);
var layersList = [lyr_GoogleMaps_0,lyr_GoogleSatellite_1,lyr_OpenStreetMap_2,lyr_BuildingConnections_3,lyr_OptimizedNetwork_4,lyr_AddressPolygons_5,lyr_AddressPoints_6,lyr_FTTH_7,lyr_DOCSIS_8,lyr_xDSL_9,lyr_Metaclusters_10,lyr_ClusterPolygons_11,lyr_VorarlbergBorder_12];
...
lyr_Metaclusters_10.set('fieldAliases', {'fid': 'fid', 'Date': 'Date', 'Bundesland': 'Bundesland', 'Gemeindes': 'Municipalities', 'Meta_Cluster_ID': 'Meta_Cluster_ID', 'Meta': 'Meta', 'Buildings': 'Buildings', 'Network_avg (m)': 'Network Avg (m)', 'HH_Cluster': 'Est. Households', 'SOHO_Cluster_1': 'Est. SOHO', 'Large_ENT_Cluster': 'Est. Large Enterprises', 'Network (m)': 'Network Total (m)', 'Anschluss_avg (m)': 'Building Connection Avg (m)', 'Anschluss (m)': 'Anschluss (m)', 'Points (%)': 'Points (%)', '< 10 Mbit/s': '< 10 Mbit/s', '≥ 10 – < 30 Mbit/s': '≥ 10 – < 30 Mbit/s', '≥ 30 – < 100 Mbit/s': '≥ 30 – < 100 Mbit/s', '≥ 100 – < 1000 Mbit/s': '≥ 100 – < 1000 Mbit/s', '≥ 1000 Mbit/s': '≥ 1000 Mbit/s', '< 10 Mbit/s (%)': '< 10 Mbit/s (%)', '≥ 10 – < 30 Mbit/s (%)': '≥ 10 – < 30 Mbit/s (%)', '≥ 30 – < 100 Mbit/s (%)': '≥ 30 – < 100 Mbit/s (%)', '≥ 100 – < 1000 Mbit/s (%)': '≥ 100 – < 1000 Mbit/s (%)', '≥ 1000 Mbit/s (%)': '≥ 1000 Mbit/s (%)', '4G/5G lokal': '4G/5G lokal', 'DOCSIS 1.0/2.0': 'DOCSIS 1.0/2.0', 'DOCSIS 3.0': 'DOCSIS 3.0', 'DOCSIS 3.1': 'DOCSIS 3.1', 'FTTB': 'FTTB', 'FTTH': 'FTTH', 'WLAN': 'WLAN', 'xDSL': 'xDSL', '01. Gebäude mit einer Wohnung (#)': '01. Gebäude mit einer Wohnung (#)', '02. Gebäude mit zwei oder mehr Wohnungen (#)': '02. Gebäude mit zwei oder mehr Wohnungen (#)', '03. Wohngebäude fur Gemeinschaften (#)': '03. Wohngebäude fur Gemeinschaften (#)', '04. Hotels und ähnliche Gebäude (#)': '04. Hotels und ähnliche Gebäude (#)', '05. Bürogebäude (#)': '05. Bürogebäude (#)', '06. Groß- und Einzelhandelsgebäude (#)': '06. Groß- und Einzelhandelsgebäude (#)', '07. Gebäude des Verkehrs- und Nachrichtenwesens (#)': '07. Gebäude des Verkehrs- und Nachrichtenwesens (#)', '08. Industrie- und Lagergebäude (#)': '08. Industrie- und Lagergebäude (#)', '09. Gebäude für Kultur- und Freizeitzwecke (#)': '09. Gebäude für Kultur- und Freizeitzwecke (#)', 'HH (Gemeinde)': 'HH (Gemeinde)', 'ENT (Gemeinde)': 'ENT (Gemeinde)', 'Intercluster_Distance (m)': 'Intercluster_Distance (m)', '01. Gebäude mit einer Wohnung (Gemeinde)': '01. Gebäude mit einer Wohnung (Gemeinde)', '02. Gebäude mit zwei oder mehr Wohnungen (Gemeinde)': '02. Gebäude mit zwei oder mehr Wohnungen (Gemeinde)', '03. Wohngebäude fur Gemeinschaften (Gemeinde)': '03. Wohngebäude fur Gemeinschaften (Gemeinde)', '04. Hotels und ähnliche Gebäude (Gemeinde)': '04. Hotels und ähnliche Gebäude (Gemeinde)', '05. Bürogebäude (Gemeinde)': '05. Bürogebäude (Gemeinde)', '06. Groß- und Einzelhandelsgebäude (Gemeinde)': '06. Groß- und Einzelhandelsgebäude (Gemeinde)', '07. Gebäude des Verkehrs- und Nachrichtenwesens (Gemeinde)': '07. Gebäude des Verkehrs- und Nachrichtenwesens (Gemeinde)', '08. Industrie- und Lagergebäude (Gemeinde)': '08. Industrie- und Lagergebäude (Gemeinde)', '09. Gebäude für Kultur- und Freizeitzwecke (Gemeinde)': '09. Gebäude für Kultur- und Freizeitzwecke (Gemeinde)', 'SOHO_1 (Gemeinde)': 'SOHO_1 (Gemeinde)', 'SOHO_2 (Gemeinde)': 'SOHO_2 (Gemeinde)', 'Large_ENT (Gemeinde)': 'Large_ENT (Gemeinde)', 'ENT_Buildings (#)': 'ENT_Buildings (#)', 'SOHO_Cluster_2 (#)': 'SOHO_Cluster_2 (#)', 'color_label': 'Tier', 'Speed1': '< 10 Mbit/s (%)', 'Speed2': '≥ 10 – < 30 Mbit/s (%)', 'Speed3': '≥ 30 – < 100 Mbit/s (%)', 'Speed4': '≥ 100 – < 1000 Mbit/s (%)', 'Speed5': '≥ 1000 Mbit/s (%)', });
lyr_ClusterPolygons_11.set('fieldAliases', {'fid': 'fid', 'Date': 'Date', 'Bundesland': 'Bundesland', 'Gemeinde': 'Municipality', 'Cluster_ID': 'Cluster Number', 'Sub_Cluster_ID': 'Sub_Cluster_ID', 'Buildings': 'Buildings', 'Network_avg (m)': 'Network Avg (m)', 'HH_Cluster': 'Est. Households', 'SOHO_Cluster_1': 'Est. SOHO', 'Large_ENT_Cluster': 'Est. Large Enterprises', 'Network (m)': 'Network Total (m)', 'Anschluss_avg (m)': 'Building Connection Avg (m)', 'Anschluss (m)': 'Anschluss (m)', 'Points (%)': 'Points (%)', '< 10 Mbit/s': '< 10 Mbit/s', '≥ 10 – < 30 Mbit/s': '≥ 10 – < 30 Mbit/s', '≥ 30 – < 100 Mbit/s': '≥ 30 – < 100 Mbit/s', '≥ 100 – < 1000 Mbit/s': '≥ 100 – < 1000 Mbit/s', '≥ 1000 Mbit/s': '≥ 1000 Mbit/s', '< 10 Mbit/s (%)': '< 10 Mbit/s (%)', '≥ 10 – < 30 Mbit/s (%)': '≥ 10 – < 30 Mbit/s (%)', '≥ 30 – < 100 Mbit/s (%)': '≥ 30 – < 100 Mbit/s (%)', '≥ 100 – < 1000 Mbit/s (%)': '≥ 100 – < 1000 Mbit/s (%)', '≥ 1000 Mbit/s (%)': '≥ 1000 Mbit/s (%)', '4G/5G lokal': '4G/5G lokal', 'DOCSIS 1.0/2.0': 'DOCSIS 1.0/2.0', 'DOCSIS 3.0': 'DOCSIS 3.0', 'DOCSIS 3.1': 'DOCSIS 3.1', 'FTTB': 'FTTB', 'FTTH': 'FTTH', 'WLAN': 'WLAN', 'xDSL': 'xDSL', '01. Gebäude mit einer Wohnung (#)': '01. Gebäude mit einer Wohnung (#)', '02. Gebäude mit zwei oder mehr Wohnungen (#)': '02. Gebäude mit zwei oder mehr Wohnungen (#)', '03. Wohngebäude fur Gemeinschaften (#)': '03. Wohngebäude fur Gemeinschaften (#)', '04. Hotels und ähnliche Gebäude (#)': '04. Hotels und ähnliche Gebäude (#)', '05. Bürogebäude (#)': '05. Bürogebäude (#)', '06. Groß- und Einzelhandelsgebäude (#)': '06. Groß- und Einzelhandelsgebäude (#)', '07. Gebäude des Verkehrs- und Nachrichtenwesens (#)': '07. Gebäude des Verkehrs- und Nachrichtenwesens (#)', '08. Industrie- und Lagergebäude (#)': '08. Industrie- und Lagergebäude (#)', '09. Gebäude für Kultur- und Freizeitzwecke (#)': '09. Gebäude für Kultur- und Freizeitzwecke (#)', 'HH (Gemeinde)': 'HH (Gemeinde)', 'ENT (Gemeinde)': 'ENT (Gemeinde)', '01. Gebäude mit einer Wohnung (Gemeinde)': '01. Gebäude mit einer Wohnung (Gemeinde)', '02. Gebäude mit zwei oder mehr Wohnungen (Gemeinde)': '02. Gebäude mit zwei oder mehr Wohnungen (Gemeinde)', '03. Wohngebäude fur Gemeinschaften (Gemeinde)': '03. Wohngebäude fur Gemeinschaften (Gemeinde)', '04. Hotels und ähnliche Gebäude (Gemeinde)': '04. Hotels und ähnliche Gebäude (Gemeinde)', '05. Bürogebäude (Gemeinde)': '05. Bürogebäude (Gemeinde)', '06. Groß- und Einzelhandelsgebäude (Gemeinde)': '06. Groß- und Einzelhandelsgebäude (Gemeinde)', '07. Gebäude des Verkehrs- und Nachrichtenwesens (Gemeinde)': '07. Gebäude des Verkehrs- und Nachrichtenwesens (Gemeinde)', '08. Industrie- und Lagergebäude (Gemeinde)': '08. Industrie- und Lagergebäude (Gemeinde)', '09. Gebäude für Kultur- und Freizeitzwecke (Gemeinde)': '09. Gebäude für Kultur- und Freizeitzwecke (Gemeinde)', 'SOHO_1 (Gemeinde)': 'SOHO_1 (Gemeinde)', 'SOHO_2 (Gemeinde)': 'SOHO_2 (Gemeinde)', 'Large_ENT (Gemeinde)': 'Large_ENT (Gemeinde)', 'ENT_Buildings (#)': 'ENT_Buildings (#)', 'SOHO_Cluster_2 (#)': 'SOHO_Cluster_2 (#)', 'SDU_Factor': 'SDU_Factor', 'MDU_Factor': 'MDU_Factor', 'ENT_Faktor': 'ENT_Faktor', 'Speed1': '< 10 Mbit/s (%)', 'Speed2': '≥ 10 – < 30 Mbit/s (%)', 'Speed3': '≥ 30 – < 100 Mbit/s (%)', 'Speed4': '≥ 100 – < 1000 Mbit/s (%)', 'Speed5': '≥ 1000 Mbit/s (%)', });
lyr_VorarlbergBorder_12.set('fieldAliases', {'fid': 'fid', 'id': 'id', 'name': 'name', });
...
lyr_Metaclusters_10.set('fieldLabels', {'Bundesland': 'inline label', 'Gemeindes': 'inline label', 'Buildings': 'inline label', 'Network_avg (m)': 'inline label', 'HH_Cluster': 'inline label', 'SOHO_Cluster_1': 'inline label', 'Large_ENT_Cluster': 'inline label', 'Network (m)': 'inline label', 'Anschluss_avg (m)': 'inline label', 'color_label': 'inline label', 'Speed1': 'inline label', 'Speed2': 'inline label', 'Speed3': 'inline label', 'Speed4': 'inline label', 'Speed5': 'inline label', });
lyr_ClusterPolygons_11.set('fieldLabels', {'Bundesland': 'inline label', 'Gemeinde': 'inline label', 'Cluster_ID': 'inline label', 'Buildings': 'inline label', 'Network_avg (m)': 'inline label', 'HH_Cluster': 'inline label', 'SOHO_Cluster_1': 'inline label', 'Large_ENT_Cluster': 'inline label', 'Network (m)': 'inline label', 'Anschluss_avg (m)': 'inline label', 'Speed1': 'inline label', 'Speed2': 'inline label', 'Speed3': 'inline label', 'Speed4': 'inline label', 'Speed5': 'inline label', });
lyr_VorarlbergBorder_12.set('fieldLabels', {});
lyr_VorarlbergBorder_12.on('precompose', function(evt) {
